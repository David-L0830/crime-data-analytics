...
//
// Only the anon (public) key belongs here. The service-role key must NEVER
// be used in frontend code — it stays server-side only (backend .env, used
// only by App\Services\SupabaseAdminService).
