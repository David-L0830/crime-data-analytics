...
export default function Login() {
  ...
  return (
    <>
      {/* Shared sign-in frame (seal, "Barangay 178 CDARS", subtitle, card) —
          see components/auth/AuthLayout.jsx. Every step below renders inside
          its card. */}
      <AuthLayout
        subtitle="Sign in to your account"
        after={
          // Kept reachable before sign-in: the privacy notice is what a
          // person is entitled to read before handing over credentials.
          <nav className="cdars-login-legal" aria-label="Legal">
        ...
        {pendingMfaEnrollment ? (
          ...
          >
            <div className="form-group">
              ...
              <div className="input-wrapper">
                <span className="input-icon">
                  <Icons.Mail size={16} strokeWidth={2} />
                </span>
                <input
                  type="email"
                  id="email"
            ...
            >
              {submitting ? (
                ...
                <Icons.LogIn size={17} strokeWidth={2.25} aria-hidden="true" />
              )}
